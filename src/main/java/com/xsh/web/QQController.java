...
public class QQController {
    ...
    public String qqcallback(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if(queryInfo == null){
            ...
            if(queryInfo.getEmail() != null){
                session.setAttribute("email",queryInfo.getEmail());
            }
        }
    ...
    @GetMapping("/qqInfo")
    public String logout(String qqNumber) throws Exception {
        HttpClientUtils.doGet("https://r.qzone.qq.com/fcg-bin/cgi_get_portrait.fcg?g_tk=1518561325&uins="+qqNumber);
